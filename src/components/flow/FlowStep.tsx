...
export const FlowStep = ({
  ...
  <div className="relative md:w-1/2" style={isOdd ? { alignSelf: "flex-start" } : { alignSelf: "flex-end" }}>
    <div className={`relative rounded-2xl p-5 shadow-md ring-1 ring-slate-200/80 transition-all duration-300 hover:shadow-xl hover:ring-slate-300 md:flex md:items-start md:gap-6 ${boxBgColor || "bg-white"} ${isOdd ? "md:mr-8" : "md:ml-8"}`}>
